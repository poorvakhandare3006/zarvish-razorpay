...
<div class="container">
  ...
  <ul class="nav nav-pills  nav-justified" id="profileTabs">
    ...
    <li><a data-toggle="tab" href="#menu3">Your Earning</a></li>
...
?>
       ...
       <div class="cart-header">
         ...
         <div class="cart-sec simpleCart_shelfItem">
            ...
            <br>
            Size:  <?php echo $product_size; ?> <?php echo "$days_interval"; ?>
...
$Cashback_amount = ceil((0.13)* (int) $product_selling_price);
...
?>
       ...
       <div class="cart-header">
         ...
         <div class="cart-sec simpleCart_shelfItem">
            ...
            <br>
            Unit Price: &#8360; <?php echo $product_selling_price; ?><?php echo "$days_interval"; ?>
            <br>
            ...
            <?php } else if ($days_interval >=15) { ?>
              <p style="color:green;font-weight:bold;font-size:1.1em;">Congtratulation Very soon we will initiate your cashback in your bank account.</p> 
            <?php } ?>
            <?php if ($is_cancelled =='no' && $is_delivered == 'no') {?>
            <p style="color:red;font-weight:bold;font-size:1.1em;">Your Earning : &#8377;<?php echo "$Cashback_amount"; ?>&nbsp;(Pending)</p> 
